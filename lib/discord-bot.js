...
class DiscordBotManager {
  ...
  discordRequest(endpoint, method = 'GET', data = null, headers = {}) {
    return new Promise((resolve, reject) => {
      ...
      const pkgVersion = require('../package.json').version || '4.0.0';
      const reqHeaders = {
    ...
    return new Promise((resolve, reject) => {
      ...
      const req = https.request({
        ...
        headers: {
          ...
          'User-Agent': `DiscordBot (nyx-dlp, ${require('../package.json').version || '4.0.0'})`
        },
        timeout: 60000
      }, (res) => {
        res.on('data', () => {});
    ...
    if (commandName === 'status') {
      ...
      await this.updateInteractionResponse(token, {
        ...
        fields: [
          ...
          { name: 'Engine Version', value: `nyx-dlp v${require('../package.json').version || '4.0.0'}`, inline: true }
        ],
