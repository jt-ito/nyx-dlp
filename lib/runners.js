...
// VERSION STAMP — prints on module load, before any clip/download even runs. If this
// line is NOT in your Electron console/log output after restarting, this file is not
// the one being loaded (wrong path, stale build output, bundler cache, etc.) — check
// that before anything else. Bump the date/string whenever this file changes.
console.log('[runners.js] loaded build: clip-smart-cut-2026-08-21-v35 (Full Process Control: Pause, Resume & Stop guaranteed)');
