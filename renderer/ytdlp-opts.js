...
const YTDLP_OPTS = [
  ...
  { cat:'File & Naming', key:'write-comments',      flag:'--write-comments',       hasVal:false, label:'Write comments',           desc:'Retrieve and embed video comments into .info.json (also contains title & metadata)', type:'toggle' },
